   ...
   public abstract class BaseEditorHelper : Crosstales.Common.Util.BaseHelper
   {
      ...
      */
      ...
      private static string generateWindowsRestartScript(string executeMethod)
      {
         ...
         sb.AppendLine("echo ##############################################################################");
         sb.AppendLine("echo #                                                                            #");
         sb.AppendLine($"echo #  Common {Crosstales.Common.Util.BaseConstants.COMMON_VERSION} - Windows                                                 #");
      ...
      private static string generateMacRestartScript(string executeMethod)
      {
         ...
         sb.AppendLine("echo \"+----------------------------------------------------------------------------+\"");
         sb.AppendLine("echo \"¦                                                                            ¦\"");
         sb.AppendLine($"echo \"¦  Common {Crosstales.Common.Util.BaseConstants.COMMON_VERSION} - macOS                                                   ¦\"");
         sb.AppendLine("echo \"¦  Copyright 2018-2024 by www.crosstales.com                                 ¦\"");
         sb.AppendLine("echo \"¦                                                                            ¦\"");
         sb.AppendLine("echo \"¦  This script restarts Unity.                                               ¦\"");
         sb.AppendLine("echo \"¦  This will take some time, so please be patient and DON'T CLOSE THIS       ¦\"");
      ...
      private static string generateLinuxRestartScript(string executeMethod)
      {
         ...
         sb.AppendLine("echo \"+----------------------------------------------------------------------------+\"");
         sb.AppendLine("echo \"¦                                                                            ¦\"");
         sb.AppendLine($"echo \"¦  Common {Crosstales.Common.Util.BaseConstants.COMMON_VERSION} - Linux                                                   ¦\"");
         sb.AppendLine("echo \"¦  Copyright 2018-2024 by www.crosstales.com                                 ¦\"");
         sb.AppendLine("echo \"¦                                                                            ¦\"");
         sb.AppendLine("echo \"¦  This script restarts Unity.                                               ¦\"");
         sb.AppendLine("echo \"¦  This will take some time, so please be patient and DON'T CLOSE THIS       ¦\"");
