...
namespace Crosstales.Ude
{
   ...
   {
      private readonly System.Collections.Generic.Dictionary<string, int> codepages = new System.Collections.Generic.Dictionary<string, int>
      {
         {"UTF-8", 65001},
         {"UTF-16BE", 1201},
         {"UTF-16LE", 1200},
      ...
      public int CodePage
      {
         get
         {
            ...
            //UnityEngine.Debug.LogWarning($"Could not determine codepage for '{Charset}' - returning UTF8!");
            return 65001;
         }
      }
