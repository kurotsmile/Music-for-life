...
public class Panel_footer : MonoBehaviour
{
    ...
    {
        // Move menu buttons back to footer area before closing the full menu.
        bool is_portrait = Screen.height >= Screen.width;
        if (is_portrait)
            this.show_menu_for_portrait();
        else
            this.show_menu_for_landscape();
